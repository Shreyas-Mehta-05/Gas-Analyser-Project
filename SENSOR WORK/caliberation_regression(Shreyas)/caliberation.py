...
# 2024-10-14T22:10:33+00:00,1,5.89,7.35,,,,,,,,,,
# 2024-10-14T22:10:35+00:00,2,,,,,,,27.80,67.00,,,,
# 2024-10-14T22:10:37+00:00,3,,,716.26,0.33,,,,,,,,
# 2024-10-14T22:10:39+00:00,4,,,,,2809.30,1.67,,,,,,
# 2024-10-14T22:10:44+00:00,5,6.22,6.77,,,,,,,,,,
# 2024-10-14T22:10:46+00:00,6,,,,,,,27.80,67.00,,,,
# 2024-10-14T22:10:48+00:00,7,,,727.85,0.32,,,,,,,,
# 2024-10-14T22:10:50+00:00,8,,,,,2929.94,1.43,,,,,,
# 2024-10-14T22:10:55+00:00,9,6.28,6.69,,,,,,,,,,
# 2024-10-14T22:10:57+00:00,10,,,,,,,27.80,67.00,,,,
...
# we will draw the graph please note that at any given point data was send in the following order:
# mq7 Rs, mq7 ppm, mq9 Rs, mq9 ppm, mq136 Rs, mq136 ppm, Temperature, Humidity
# so we have to extract the data accordingly
#and plot the graph
...
# Plot for MQ7
plt.subplot(3, 1, 1)
plt.plot(mq7_rs, label='MQ7 Rs', color=colors[0], linewidth=1.5)
plt.plot(mq7_rs_ma, label=f'MQ7 Rs (MA, window={window_size})', linestyle='--', color=colors[0], linewidth=2, alpha=0.7)
plt.fill_between(mq7_rs.index, mq7_rs_ma, mq7_rs, color=colors[0], alpha=0.1)  # Shaded area between Rs and MA
plt.title('MQ7 Sensor Rs and Moving Average', fontsize=14, fontweight='bold')
...
# Plot for MQ9
plt.subplot(3, 1, 2)
plt.plot(mq9_rs, label='MQ9 Rs', color=colors[1], linewidth=1.5)
plt.plot(mq9_rs_ma, label=f'MQ9 Rs (MA, window={window_size})', linestyle='--', color=colors[1], linewidth=2, alpha=0.7)
plt.fill_between(mq9_rs.index, mq9_rs_ma, mq9_rs, color=colors[1], alpha=0.1)  # Shaded area between Rs and MA
plt.title('MQ9 Sensor Rs and Moving Average', fontsize=14, fontweight='bold')
plt.xlabel('Time', fontsize=12)
plt.ylabel('Rs', fontsize=12)
plt.legend(fontsize=10)
plt.grid(True)
...
# Plot for MQ136
plt.subplot(3, 1, 3)
plt.plot(mq136_rs, label='MQ136 Rs', color=colors[2], linewidth=1.5)
plt.plot(mq136_rs_ma, label=f'MQ136 Rs (MA, window={window_size})', linestyle='--', color=colors[2], linewidth=2, alpha=0.7)
plt.fill_between(mq136_rs.index, mq136_rs_ma, mq136_rs, color=colors[2], alpha=0.1)  # Shaded area between Rs and MA
plt.title('MQ136 Sensor Rs and Moving Average', fontsize=14, fontweight='bold')
plt.xlabel('Time', fontsize=12)
plt.ylabel('Rs', fontsize=12)
plt.legend(fontsize=10)
plt.grid(True)
...
# Plot for MQ7 PPM
plt.subplot(3, 1, 1)
plt.plot(mq7_ppm, label='MQ7 ppm', color=colors[0], linewidth=1.5)
plt.fill_between(mq7_ppm.index, mq7_ppm, color=colors[0], alpha=0.1)  # Shaded area between Rs and MA
plt.title('MQ7 Sensor ppm', fontsize=14, fontweight='bold')
plt.xlabel('Time', fontsize=12)
...
# Plot for MQ9 PPM
plt.subplot(3, 1, 2)
plt.plot(mq9_ppm, label='MQ9 ppm', color=colors[1], linewidth=1.5)
plt.fill_between(mq9_ppm.index, mq9_ppm, color=colors[1], alpha=0.1)  # Shaded area between Rs and MA
plt.title('MQ9 Sensor ppm', fontsize=14, fontweight='bold')
plt.xlabel('Time', fontsize=12)
plt.ylabel('ppm', fontsize=12)
plt.legend(fontsize=10)
plt.grid(True)
...
# Plot for MQ136 PPM
plt.subplot(3, 1, 3)
plt.plot(mq136_ppm, label='MQ136 ppm', color=colors[2], linewidth=1.5)
plt.fill_between(mq136_ppm.index, mq136_ppm, color=colors[2], alpha=0.1)  # Shaded area between Rs and MA
plt.title('MQ136 Sensor ppm', fontsize=14, fontweight='bold')
plt.xlabel('Time', fontsize=12)
plt.ylabel('ppm', fontsize=12)
plt.legend(fontsize=10)
plt.grid(True)
...
# MQ7 plot
plt.subplot(3, 1, 1)
plt.plot(mq7_Ro, label='MQ7 Ro', color=colors[0], linewidth=1.5)
...
# MQ9 plot
plt.subplot(3, 1, 2)
plt.plot(mq9_Ro, label='MQ9 Ro', color=colors[1], linewidth=1.5)
...
# MQ136 plot
plt.subplot(3, 1, 3)
plt.plot(mq136_Ro, label='MQ136 Ro', color=colors[2], linewidth=1.5)
...
mq7_power_ma = movingaverage(mq7_power, window_size)
mq9_power_ma = movingaverage(mq9_power, window_size)
mq136_power_ma = movingaverage(mq136_power, window_size)
...
# MQ7 Power plot
plt.subplot(3, 1, 1)
plt.plot(mq7_power, label='MQ7 Power', color=colors[0], linewidth=1.5)
# plot the moving average
plt.plot(mq7_power_ma, label=f'MQ7 Power (MA, window={window_size})', linestyle='--', color=colors[0], linewidth=2, alpha=0.7)
...
# MQ9 Power plot
plt.subplot(3, 1, 2)
plt.plot(mq9_power, label='MQ9 Power', color=colors[1], linewidth=1.5)
plt.plot(mq9_power_ma, label=f'MQ9 Power (MA, window={window_size})', linestyle='--', color=colors[1], linewidth=2, alpha=0.7)
...
# MQ136 Power plot
plt.subplot(3, 1, 3)
plt.plot(mq136_power, label='MQ136 Power', color=colors[2], linewidth=1.5)
plt.plot(mq136_power_ma, label=f'MQ136 Power (MA, window={window_size})', linestyle='--', color=colors[2], linewidth=2, alpha=0.7)
...
plt.subplot(3, 1, 2)
plt.plot(mq7_power, label='MQ7 Power', color=colors[1], linewidth=1.5)
plt.title('MQ7 Sensor Power', fontsize=16, fontweight='bold')
plt.xlabel('Sample Index', fontsize=14)
plt.ylabel('Power (W)', fontsize=14)
plt.grid(True)
...
plt.subplot(3, 1, 3)
plt.plot(mq7_ppm, label='MQ7 ppm', color=colors[2], linewidth=1.5)
...
plt.figure(figsize=(12, 10))
plt.subplot(3, 1, 1)
plt.plot(mq9_rs, label='MQ9 Rs', color=colors[0], linewidth=1.5)
plt.suptitle('Sensor Data Analysis', fontsize=18, fontweight='bold')
...
plt.subplot(3, 1, 3)
plt.plot(mq9_ppm, label='MQ9 ppm', color=colors[2], linewidth=1.5)
...
plt.figure(figsize=(12, 10))
plt.subplot(3, 1, 1)
plt.plot(mq136_rs, label='MQ136 Rs', color=colors[0], linewidth=1.5)
plt.suptitle('Sensor Data Analysis', fontsize=18, fontweight='bold')
...
plt.subplot(3, 1, 2)
plt.plot(mq136_power, label='MQ136 Power', color=colors[1], linewidth=1.5)
plt.title('MQ136 Sensor Power', fontsize=16, fontweight='bold')
plt.xlabel('Sample Index', fontsize=14)
plt.ylabel('Power (W)', fontsize=14)
plt.grid(True)
